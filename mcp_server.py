...
# ─────────────────────────────────────────────
# HTTP Server (FastAPI) - Advanced Sprint 3
# ─────────────────────────────────────────────
try:
    ...
    def start_server(*args, **kwargs):
        print("FastAPI or Uvicorn not installed. Cannot start HTTP server.")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "serve":
        ...
        print("\nTODO Sprint 3: Chạy 'python mcp_server.py serve' để start HTTP server.")
